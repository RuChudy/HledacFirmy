...
namespace HledacFirmy.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("HledacFirmy") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "HledacFirmy", DisplayName = "HledacFirmy API", Resources = { "HledacFirmy" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["HledacFirmy_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["HledacFirmy_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
                ...
                scopes: commonScopes,
                redirectUris: new List<string> { consoleAndAngularClientRootUrl ?? string.Empty },
                postLogoutRedirectUris: new List<string> { consoleAndAngularClientRootUrl ?? string.Empty },
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["HledacFirmy_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["HledacFirmy_Swagger:RootUrl"]?.TrimEnd('/');
